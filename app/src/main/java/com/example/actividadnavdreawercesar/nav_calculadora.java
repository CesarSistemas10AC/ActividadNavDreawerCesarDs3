...
public class nav_calculadora extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_nav_calculadora, container, false);
        ...
        btnRnd = view.findViewById(R.id.button12);
        btnLimpiar = view.findViewById(R.id.button11);
